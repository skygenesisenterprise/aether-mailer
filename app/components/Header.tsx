          ...
          <div className="w-full max-w-xl">
            <div className="relative">
              ...
              <input
                ...
                className="w-full h-10 pl-10 pr-4 text-sm bg-muted/50 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent placeholder:text-muted-foreground/60"
              />
            </div>
          </div>
        </div>
              ...
              <div className="absolute right-0 mt-2 w-80 bg-popover border border-border rounded-lg shadow-lg p-4 z-50">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-3 p-2 hover:bg-muted/50 rounded-lg cursor-pointer">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium">Espace disque à 67%</p>
                      <p className="text-xs text-muted-foreground">
                        Il y a 1 heure
                      </p>
                    </div>
          ...
          <div className="relative">
            ...
            {isUserMenuOpen && (
              <div className="absolute right-0 mt-2 w-56 bg-popover border border-border rounded-lg shadow-lg py-2 z-50">
                ...
                <div className="py-1">
                  <button className="w-full flex items-center gap-2 px-3 py-2 text-sm hover:bg-muted/50 transition-colors">
                ...
                <div className="py-1 border-t border-border">
                  <button className="w-full flex items-center gap-2 px-3 py-2 text-sm hover:bg-muted/50 transition-colors text-red-600">
